...
// extern int rand(void);	   // Functions CNET_rand, CNET_srand, CNET_nextrand,
// extern void srand(unsigned);    // and CNET_newrand are removed from v3.4.1.
                                   // The extern declarations are not needed if
				   // <stdlib.h> is included. CNET, however, redefines
				   // rand() and srand() to generate independent
